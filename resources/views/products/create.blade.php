                ...
                <form method="POST" action="{{route('productos.store')}}">
                    ...
                    <div class="form-row align-items-center">
                        <div class="col-auto my-1">
                          ...
                          <select class="custom-select mr-sm-2 mb-3" id="inlineFormCustomSelect" name ="supermercado">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="producto" class="form-control" id="exampleInputProduct" aria-describedby="productoHelp">
                    </div>
                    <div class="form-group">
